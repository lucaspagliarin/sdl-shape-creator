...
void Painter::setPixel(int x, int y, Uint32 cor) {
...
void Painter::setPixel(int x, int y, Color color) {
...
void Painter::bresenham(int x1, int y1, int x2, int y2, int r, int g, int b)
{
